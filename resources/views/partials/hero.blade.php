        ...
        <div class="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div class="space-y-8">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="https://wa.me/6285183360304" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-400/10 px-5 py-2.5 text-sm font-semibold text-emerald-100 shadow-sm transition hover:border-emerald-300/60 hover:bg-emerald-400/20">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12.04 2C6.57 2 2.13 6.37 2.13 11.73c0 1.86.53 3.66 1.53 5.24L2 22l5.2-1.71a10.1 10.1 0 004.84 1.24c5.47 0 9.91-4.37 9.91-9.73C21.96 6.37 17.5 2 12.04 2zm5.78 13.4c-.24.67-1.19 1.26-1.83 1.33-.47.05-1.08.09-3.5-.75-2.94-1.01-4.82-3.45-4.96-3.61-.14-.17-1.18-1.57-1.18-3s.75-2.13 1.02-2.42c.24-.27.63-.39 1.02-.39.12 0 .23.01.33.01.29.01.44.03.63.49.24.58.82 2 .89 2.14.07.15.11.32.02.5-.09.19-.14.31-.27.48-.14.17-.29.38-.41.51-.14.14-.29.29-.13.56.14.24.63 1.04 1.35 1.68.93.83 1.71 1.09 1.96 1.21.24.12.38.1.52-.06.14-.17.6-.7.76-.94.16-.24.33-.2.56-.12.24.08 1.51.7 1.77.83.26.13.43.19.49.3.08.13.08.74-.16 1.41z"/></svg>
                        WhatsApp 1
                    </a>
                    <a href="https://wa.me/6282139939685" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-400/10 px-5 py-2.5 text-sm font-semibold text-emerald-100 shadow-sm transition hover:border-emerald-300/60 hover:bg-emerald-400/20">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12.04 2C6.57 2 2.13 6.37 2.13 11.73c0 1.86.53 3.66 1.53 5.24L2 22l5.2-1.71a10.1 10.1 0 004.84 1.24c5.47 0 9.91-4.37 9.91-9.73C21.96 6.37 17.5 2 12.04 2zm5.78 13.4c-.24.67-1.19 1.26-1.83 1.33-.47.05-1.08.09-3.5-.75-2.94-1.01-4.82-3.45-4.96-3.61-.14-.17-1.18-1.57-1.18-3s.75-2.13 1.02-2.42c.24-.27.63-.39 1.02-.39.12 0 .23.01.33.01.29.01.44.03.63.49.24.58.82 2 .89 2.14.07.15.11.32.02.5-.09.19-.14.31-.27.48-.14.17-.29.38-.41.51-.14.14-.29.29-.13.56.14.24.63 1.04 1.35 1.68.93.83 1.71 1.09 1.96 1.21.24.12.38.1.52-.06.14-.17.6-.7.76-.94.16-.24.33-.2.56-.12.24.08 1.51.7 1.77.83.26.13.43.19.49.3.08.13.08.74-.16 1.41z"/></svg>
                        WhatsApp 2
                    </a>
                    <a href="https://www.instagram.com/hakordia.run.2025/" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full border border-pink-400/40 bg-pink-500/10 px-5 py-2.5 text-sm font-semibold text-pink-100 shadow-sm transition hover:border-pink-300/60 hover:bg-pink-500/20">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.66 0 3 1.34 3 3v10c0 1.66-1.34 3-3 3H7c-1.66 0-3-1.34-3-3V7c0-1.66 1.34-3 3-3h10zm-5 3a5 5 0 100 10 5 5 0 000-10zm0 2.2a2.8 2.8 0 110 5.6 2.8 2.8 0 010-5.6zM17.75 5.5a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z"/></svg>
                        Instagram
                    </a>
                </div>
                </div>
