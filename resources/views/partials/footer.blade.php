    ...
    <div class="relative mx-auto max-w-6xl px-6 pt-24 pb-16">
        <div class="grid gap-12 lg:grid-cols-[1.2fr_1fr] items-center">
            <div class="space-y-6 text-center lg:text-left">
                ...
                <div class="flex flex-col items-center justify-center gap-3 text-sm lg:flex-row lg:justify-start">
                    <a href="https://wa.me/6285183360304" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-5 py-2.5 font-semibold text-emerald-100 transition hover:border-emerald-300/60 hover:bg-emerald-500/20">
                    ...
                    <a href="https://www.instagram.com/hakordia.run.2025/" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-full border border-pink-400/40 bg-pink-500/10 px-5 py-2.5 font-semibold text-pink-100 transition hover:border-pink-300/60 hover:bg-pink-500/20">
