...
<div class="min-h-[60vh] flex flex-col items-center justify-center py-16">
    <div class="flex flex-col items-center gap-6">
        <div class="bg-primary/10 rounded-full p-6 shadow-lg mb-2">
            <svg class="w-20 h-20 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 48 48">
        ...
        <h1 class="text-6xl font-extrabold text-primary drop-shadow">404</h1>
        ...
        <a href="{{ route('home') }}" class="mt-4 inline-flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-full font-bold shadow hover:bg-primary/90 transition">
